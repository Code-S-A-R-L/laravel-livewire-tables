...
class RappasoftFrontendAssets
{
    ...
    public function boot(): void
    {
        ...
        app($this::class)->setRappasoftTableScriptRoute(function ($handle) {
            $scriptPath = rtrim(config('livewire-tables.script_base_path', '/code-s-a-r-l/laravel-livewire-tables'), '/').'/core.min.js';
        ...
        app($this::class)->setRappasoftTableStylesRoute(function ($handle) {
            $stylesPath = rtrim(config('livewire-tables.script_base_path', '/code-s-a-r-l/laravel-livewire-tables'), '/').'/core.min.css';
        ...
        app($this::class)->setRappasoftTableThirdPartyScriptRoute(function ($handle) {
            $scriptPath = rtrim(config('livewire-tables.script_base_path', '/code-s-a-r-l/laravel-livewire-tables'), '/').'/thirdparty.min.js';
        ...
        app($this::class)->setRappasoftTableThirdPartyStylesRoute(function ($handle) {
            $stylesPath = rtrim(config('livewire-tables.script_base_path', '/code-s-a-r-l/laravel-livewire-tables'), '/').'/thirdparty.css';
