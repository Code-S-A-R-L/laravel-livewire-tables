...
final class AutoInjectRappasoftAssetsTest extends TestCase
{
    public function test_should_inject_rappasoft_and_third_party()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('<link href="/code-s-a-r-l/laravel-livewire-tables/core.min.css" rel="stylesheet" />', $injectionReturn);
        $this->assertStringContainsStringIgnoringCase('<script src="/code-s-a-r-l/laravel-livewire-tables/core.min.js"  ></script>', $injectionReturn);
        $this->assertStringContainsStringIgnoringCase('<link href="/code-s-a-r-l/laravel-livewire-tables/thirdparty.css" rel="stylesheet" />', $injectionReturn);
        $this->assertStringContainsStringIgnoringCase('<script src="/code-s-a-r-l/laravel-livewire-tables/thirdparty.min.js"  ></script>', $injectionReturn);
    }
